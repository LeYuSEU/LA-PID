...
def build_experiment_folder(args, experiment_name):
    ...
    src_path = os.path.join(os.path.dirname(experiment_path), 'experiment_config', args.name_of_args_json_file)

    # if not os.path.exists(experiment_path + '/config.json'):
    #     shutil.copy(src_path, experiment_path)
    #     os.rename(f'{experiment_path}' + '/' + args.name_of_args_json_file, experiment_path + '/config.json')
...
def change_json_log_experiment_status(experiment_status, experiment_log_dir, log_name="experiment_log.json"):
    ...
    update_json_experiment_log_dict(key="experiment_status", value=experiment_status, experiment_log_dir=experiment_log_dir, log_name=log_name)
